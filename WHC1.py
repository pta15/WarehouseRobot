...
canvasframe = Canvas(window,width=1900, height=200, bg='red')
####################################################################################
...
# Dark Blue option
buttondarkblue=Button(canvasframe,bg=color[1],
               height=3, width=4)
buttondarkblue.place(x=1375,y=60)
# Light Blue option
buttonlightblue=Button(canvasframe,bg=color[2],
               height=3, width=4)
buttonlightblue.place(x=1425,y=60)
# Grey option
buttongrey=Button(canvasframe,bg=color[3],
               height=3, width=4)
buttongrey.place(x=1475,y=60)
# Violet option
buttonviolet=Button(canvasframe,bg=color[4],
               height=3, width=4)
buttonviolet.place(x=1525,y=60)
# Dark Orange option
buttondarkorange=Button(canvasframe,bg=color[5],
               height=3, width=4)
buttondarkorange.place(x=1575,y=60)
# Orange option
buttonorange=Button(canvasframe,bg=color[6],
               height=3, width=4)
buttonorange.place(x=1625,y=60)
# Salmon option
buttonsalmon=Button(canvasframe,bg=color[7],
               height=3, width=4)
buttonsalmon.place(x=1675,y=60)
# Second row
# Pink option
buttonpink=Button(canvasframe,bg=color[8],
               height=3, width=4)
buttonpink.place(x=1325,y=120)
# Purple option
buttonpurple=Button(canvasframe,bg=color[9],
               height=3, width=4)
buttonpurple.place(x=1375,y=120)
# Red option
buttonred=Button(canvasframe,bg=color[10],
               height=3, width=4)
buttonred.place(x=1425,y=120)
# Silver option
buttonsilver=Button(canvasframe,bg=color[11],
               height=3, width=4)
buttonsilver.place(x=1475,y=120)
# Green option
buttongreen=Button(canvasframe,bg=color[12],
               height=3, width=4)
buttongreen.place(x=1525,y=120)
# Light Green option
buttonlightgreen=Button(canvasframe,bg=color[13],
               height=3, width=4)
buttonlightgreen.place(x=1575,y=120)
# Dark Green option
buttondarkgreen=Button(canvasframe,bg=color[14],
               height=3, width=4)
buttondarkgreen.place(x=1625,y=120)
# Brown option
buttonbrown=Button(canvasframe,bg=color[15],
               height=3, width=4)
